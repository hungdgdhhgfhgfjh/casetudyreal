...
$findsmartphone  = "SELECT * FROM `products` WHERE product_type_id =1 limit 5";
//thực hiện truy vấn
...
<div style="margin-top: 108px;">
    <h3 class="sanpham"> sản Phẩm khác </h3>
    <div style="display:flex;">
        ...
        <div>
            ...
            <a href="product.php?id=<?php echo $product->id; ?>" style="width: 64px;margin-left: 70px;margin-top: -13px;background: #e67e22;border-radius: 21px;display: block;height: 26px;text-align: center;">mua</a>
